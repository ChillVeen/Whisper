...
struct EmptyChatNotice: View {
    var body: some View {
        ...
        VStack(alignment: .listRowSeparatorLeading, spacing: 10) {
            Text("Go to ") +
            Text("\(Image(systemName: "point.3.connected.trianglepath.dotted"))Discover ").foregroundColor(.accentColor) +
            Text("page and invite nearby peers to your chat session!")
            
            Text("Or you can check your settings and see if you are allowing others to find you under Profile page for nearby peers to send invitations.")
        }
        .font(.caption)
